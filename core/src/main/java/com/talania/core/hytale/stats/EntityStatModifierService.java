...
/**
 * Applies namespaced modifiers to Hytale {@code EntityStatMap} values.
 *
 * <p>How it works:</p>
 * <ul>
 *   <li>Resolves a stable stat index from the Hytale asset map.</li>
 *   <li>Applies/removes modifiers using a namespaced key to avoid collisions.</li>
 *   <li>Refreshes stat indices if the asset map changes during load.</li>
 * </ul>
 *
 * <p>How to use it:</p>
 * <ul>
 *   <li>Initialize a registry and call {@link EntityStatModifierRegistry#registerDefaults()}.</li>
 *   <li>Call {@link #applyMaxModifier} to change max values.</li>
 *   <li>Call {@link #removeModifier} during cleanup or resync.</li>
 * </ul>
 *
 * <p>Integration with Hytale:</p>
 * <ul>
 *   <li>Uses {@code EntityStatMap} and {@code StaticModifier} for server stats.</li>
 * </ul>
 */
