...
/**
 * Tracks cooldowns per entity and optionally applies a status effect icon.
 *
 * <p>Cooldowns are keyed by (ownerId, abilityId). This service is standalone and
 * can be dropped if a different cooldown system is used.</p>
 */
